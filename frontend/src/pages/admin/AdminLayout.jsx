...
import { HiChartPie, HiShoppingBag, HiClipboardList, HiTag, HiUsers, HiMenu, HiX, HiHome } from 'react-icons/hi';
...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { name: 'Coupons', path: '/admin/coupons', icon: HiTag },
    { name: 'Users', path: '/admin/users', icon: HiUsers },
    { name: 'Settings', path: '/admin/settings', icon: HiMenu },
  ];
